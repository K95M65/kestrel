...
> These docs describe the **current** code under `integrations/perception-service/src`. The repo-root
> `docs/perception-service.md` and the top-level `integrations/perception-service/README.md` predate the
