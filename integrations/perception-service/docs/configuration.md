...
(e.g. `ACTION__MODEL=x3d`). See `src/config.py` and `integrations/perception-service/.env.example`.
...
| `CRYPTO__KEY_DIR` | `~/.integrations/perception-service/keys` | RSA key persistence |
