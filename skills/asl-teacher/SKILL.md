...
Prefer the phrase-teacher app: `[HW:/plugin/start:{"name":"asl-teacher"}]`. If start fails, Install Phrase teacher under Device → Plugins, or speak one line and play the matching emotion:
```
