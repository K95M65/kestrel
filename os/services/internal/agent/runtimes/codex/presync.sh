...
#
# This file is EMBEDDED IN os-server (internal/agent/runtimes/codex/presync.sh) and
...
# (internal/agent/runtimes/codex/mcp.go) owns those entries. IMPORTANT: the Go writers
...
# (os-server internal/agent/runtimes/codex/mcp.go owns those entries).
...
umask 077
{
  ...
  # CODEX_WS_TOKEN MUST match internal/agent/runtimes/codex/constants.go Token; read by
...
# internal/agent/runtimes/codex/channels.go.
