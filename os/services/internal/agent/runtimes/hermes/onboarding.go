...
// internal/agent/runtimes/openclaw/service_setup.go RestartAgent (which restarts the openclaw
...
// separator line. Copied from internal/agent/runtimes/openclaw/onboarding.go stripMarkedBlock
