...
#    The unit body MUST stay in sync with agent-runtimes/claudecode/gateway_unit.go
...
#    WebSocket at /claude/ws/ to match agent-runtimes/claudecode/constants.go WSURL,
...
# agent-runtimes/claudecode/gateway_unit.go.
