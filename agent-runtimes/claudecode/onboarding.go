...
// imports. Identical template to agent-runtimes/openclaw/resources/KNOWLEDGE.md.
//
//go:embed resources/KNOWLEDGE.md
var knowledgeFS embed.FS

// Onboarding (Claude Code). Mirrors agent-runtimes/picoclaw/onboarding.go, trimmed to
// what the Claude Code backend owns on-device:
//
//   - The Claude Code CLI is installed out-of-process by
//     agent-runtimes/claudecode/install.sh (no bun/channel plugins — telegram +
...
const (
	...
	// derived from agent-runtimes/picoclaw/onboarding.go agentsMDBlock with the
...
// separator. Copied from agent-runtimes/openclaw/onboarding.go (package-private there).
