...
#
# Three layers, mirroring agent-runtimes/hermes/presync.sh:
...
#
# This file is EMBEDDED IN os-server (agent-runtimes/picoclaw/presync.sh) and materialized
...
# MUST equal agent-runtimes/picoclaw/constants.go Token — os-server connects to the pico
