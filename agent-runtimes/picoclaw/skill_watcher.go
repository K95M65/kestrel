...
// the workspace skills from the CDN. Mirrors agent-runtimes/openclaw/skill_watcher.go: the
// CDN fetch / atomic extract / content-hash plumbing is runtime-agnostic and lives in
// system/skills; this file holds only the picoclaw-specific loop, target dir, and
