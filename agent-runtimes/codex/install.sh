...
#    agent-runtimes/codex/constants.go, and its bearer token must equal constants.go
...
# MUST stay in sync with agent-runtimes/codex/gateway_unit.go codexUnitContent
