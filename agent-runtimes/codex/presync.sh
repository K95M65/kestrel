...
#
# This file is EMBEDDED IN os-server (agent-runtimes/codex/presync.sh) and
...
# (agent-runtimes/codex/mcp.go) owns those entries. IMPORTANT: the Go writers
...
# (os-server agent-runtimes/codex/mcp.go owns those entries).
...
umask 077
{
  ...
  # CODEX_WS_TOKEN MUST match agent-runtimes/codex/constants.go Token; read by
...
# agent-runtimes/codex/channels.go.
