...
//
// OpenClaw runs an `emotion-acknowledge` hook (agent-runtimes/openclaw/hooks/emotion-acknowledge/
...
// ackSkipPrefixes mirror agent-runtimes/openclaw/hooks/emotion-acknowledge/handler.ts exactly: passive
