...
#
# This file is EMBEDDED IN os-server (agent-runtimes/hermes/presync.sh) and materialized
...
# API_SERVER_KEY MUST equal agent-runtimes/hermes/constants.go APIKey.
