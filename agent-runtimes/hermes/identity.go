...
// hermesHome is the Hermes data dir (matches agent-runtimes/hermes/install.sh HERMES_DIR
...
// yourself Noah"). Mirrors agent-runtimes/openclaw/service_identity.go WatchIdentity —
