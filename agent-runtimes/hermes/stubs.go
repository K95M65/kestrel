...
// mirroring agent-runtimes/openclaw/service_identity.go.
...
// mirroring agent-runtimes/openclaw/skill_watcher.go.
...
// agent-runtimes/openclaw/mcp.go (which edits openclaw.json mcp.servers).
