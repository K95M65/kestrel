...
// agent-runtimes/openclaw/service_setup.go RestartAgent (which restarts the openclaw
...
// separator line. Copied from agent-runtimes/openclaw/onboarding.go stripMarkedBlock
