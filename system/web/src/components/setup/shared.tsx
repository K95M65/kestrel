...
export function SectionCard({ id, title, description, icon, active, children }: {
  ...
  id: SectionId | "runtime" | "timezone" | "mcp" | "plugins" | "sleep" | "behaviors" | "uses"; title: string; description?: string; icon?: React.ReactNode; active: boolean; children: React.ReactNode;
}) {
