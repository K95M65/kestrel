...
// web UI, in whichever skills dir the ACTIVE runtime owns, and honours the same
// no-overwrite rule.
//
...
// skills.ValidateSkillName inside SaveSkill, so the HTTP and MQTT paths can
// never drift on what a legal skill name is.
...
// step. Anything unrecognised is a plain write failure.
