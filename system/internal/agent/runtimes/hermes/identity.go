...
// hermesHome is the Hermes data dir (matches internal/agent/runtimes/hermes/install.sh HERMES_DIR
...
// yourself Noah"). Mirrors internal/agent/runtimes/openclaw/service_identity.go WatchIdentity —
