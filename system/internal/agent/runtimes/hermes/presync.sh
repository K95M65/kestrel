...
#
# This file is EMBEDDED IN os-server (internal/agent/runtimes/hermes/presync.sh) and materialized
...
# API_SERVER_KEY MUST equal internal/agent/runtimes/hermes/constants.go APIKey.
