...
#
# Three layers, mirroring internal/agent/runtimes/hermes/presync.sh:
...
#
# This file is EMBEDDED IN os-server (internal/agent/runtimes/picoclaw/presync.sh) and materialized
...
# MUST equal internal/agent/runtimes/picoclaw/constants.go Token — os-server connects to the pico
