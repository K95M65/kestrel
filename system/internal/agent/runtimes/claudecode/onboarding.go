...
// imports. Identical template to internal/agent/runtimes/openclaw/resources/KNOWLEDGE.md.
//
//go:embed resources/KNOWLEDGE.md
var knowledgeFS embed.FS

// Onboarding (Claude Code). Mirrors internal/agent/runtimes/picoclaw/onboarding.go, trimmed to
// what the Claude Code backend owns on-device:
//
//   - The Claude Code CLI is installed out-of-process by
//     internal/agent/runtimes/claudecode/install.sh (no bun/channel plugins — telegram +
...
const (
	...
	// derived from internal/agent/runtimes/picoclaw/onboarding.go agentsMDBlock with the
...
// separator. Copied from internal/agent/runtimes/openclaw/onboarding.go (package-private there).
