...
#    The unit body MUST stay in sync with internal/agent/runtimes/claudecode/gateway_unit.go
...
#    WebSocket at /claude/ws/ to match internal/agent/runtimes/claudecode/constants.go WSURL,
...
# internal/agent/runtimes/claudecode/gateway_unit.go.
