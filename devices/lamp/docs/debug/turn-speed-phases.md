...
**Đụng:**
- `services/server/openclaw/delivery/sse/handler_hw.go`: route Lamp-bound markers (path bắt đầu `/wellbeing/`) tới `http://127.0.0.1:5000/api/...` thay vì lelamp `5001`. Thêm flow log `hw_wellbeing`.
