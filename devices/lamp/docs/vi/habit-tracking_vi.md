...
Camera phát hiện hành động → HAL tự ghi vào wellbeing JSONL.
...
| `services/internal/agent/runtimes/openclaw/resources/SOUL.md` | Section "Observing Habits" — ghi intent từ hội thoại |
...
| `services/internal/agent/runtimes/openclaw/onboarding.go` | Đăng ký habit vào danh sách skills |
