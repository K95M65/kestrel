...
| `system/internal/agent/runtimes/openclaw/resources/SOUL.md` | Section "Observing Habits" — ghi intent từ hội thoại |
...
| `system/internal/agent/runtimes/openclaw/onboarding.go` | Đăng ký habit vào danh sách skills |
