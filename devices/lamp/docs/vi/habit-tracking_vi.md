...
| `agent-runtimes/openclaw/resources/SOUL.md` | Section "Observing Habits" — ghi intent từ hội thoại |
...
| `agent-runtimes/openclaw/onboarding.go` | Đăng ký habit vào danh sách skills |
