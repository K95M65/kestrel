...
| `system/internal/agent/runtimes/openclaw/resources/SOUL.md` | "Observing Habits" section — conversation intent logging |
...
| `system/internal/agent/runtimes/openclaw/onboarding.go` | Registers habit in skills list |
