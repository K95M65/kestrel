...
| `services/internal/agent/runtimes/openclaw/resources/SOUL.md` | "Observing Habits" section — conversation intent logging |
...
| `services/internal/agent/runtimes/openclaw/onboarding.go` | Registers habit in skills list |
