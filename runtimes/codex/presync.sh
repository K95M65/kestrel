...
#
# This file is EMBEDDED IN os-server (runtimes/codex/presync.sh) and
...
# (runtimes/codex/mcp.go) owns those entries. IMPORTANT: the Go writers
...
umask 077
{
  ...
  # CODEX_WS_TOKEN MUST match runtimes/codex/constants.go Token; read by
