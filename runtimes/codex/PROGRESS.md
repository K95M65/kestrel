...
- [x] **Bridge (Go)** `runtimes/codex/gatewayd/` — WS server (gorilla), auth 4401, single-client
...
- [x] Go package `runtimes/codex/` — full AgentGateway: translator.go (codex exec JSONL → WSEvent),
