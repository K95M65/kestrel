...
func (s *CodexService) SendChatMessageWithImage(message string, imageBase64 string) (string, error) {
...
func (s *CodexService) SendChatMessageWithImageAndRun(message string, imageBase64 string, reqID string, runID string) (string, error) {
...
func (s *CodexService) SendSlashCommandWithImageAndRun(message string, imageBase64 string, reqID string, runID string) (string, error) {
...
func (s *CodexService) sendChat(message, imageBase64, fixedReqID, fixedRunID, sourceType string) (string, error) {
