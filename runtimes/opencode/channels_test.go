...
// Channels are device-owned under OpenCode: telegram via the getUpdates receive
...
func TestOpenCodeSupportedChannels(t *testing.T) {
	got := (&OpenCodeService{}).SupportedChannels()
...
func TestOpenCodeAddChannel(t *testing.T) {
	s := &OpenCodeService{}
...
func TestOpenCodeRefreshChannelConfig(t *testing.T) {
	s := &OpenCodeService{}
