...
#    The unit body MUST stay in sync with runtimes/claudecode/gateway_unit.go
...
#    WebSocket at /claude/ws/ to match runtimes/claudecode/constants.go WSURL,
...
# runtimes/claudecode/gateway_unit.go.
