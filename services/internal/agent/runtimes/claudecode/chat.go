...
// SendChatMessage sends a user message to Claude Code. Returns the run ID the
...
func (s *ClaudeCodeService) SendChatMessageWithImage(message string, imageBase64 string) (string, error) {
...
func (s *ClaudeCodeService) SendChatMessageWithImageAndRun(message string, imageBase64 string, reqID string, runID string) (string, error) {
...
func (s *ClaudeCodeService) SendSlashCommandWithImageAndRun(message string, imageBase64 string, reqID string, runID string) (string, error) {
...
func (s *ClaudeCodeService) sendChat(message, imageBase64, fixedReqID, fixedRunID, sourceType string) (string, error) {
	if !s.wsConnected.Load() {
		return "", fmt.Errorf("claudecode not connected")
	}
