...
// mirroring internal/agent/runtimes/openclaw/service_identity.go.
...
// mirroring internal/agent/runtimes/openclaw/skill_watcher.go.
...
// internal/agent/runtimes/openclaw/mcp.go (which edits openclaw.json mcp.servers).
