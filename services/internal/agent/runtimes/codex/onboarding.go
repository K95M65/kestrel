...
// Onboarding (Codex). Mirrors internal/agent/runtimes/openclaw/onboarding.go, but trimmed to
// what Codex actually owns on-device:
//
//   - The Codex CLI binary + systemd unit are installed out-of-process by
//     internal/agent/runtimes/codex/install.sh; presync.sh migrates the workspace files
