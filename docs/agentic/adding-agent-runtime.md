...
Source of truth for the contract: `services/domain/agent.go` (the
...
> ⚠️ **Maintenance coupling — no compile-time link.** `services/internal/agent/runtimes/openclaw/hooks/emotion-acknowledge/
