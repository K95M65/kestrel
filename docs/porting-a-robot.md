...
The long form of the README's *Your own robot* section — every step with its file paths, sizes and caveats. Read [`devices/contract/DEVICE-SPEC.md`](../devices/contract/DEVICE-SPEC.md) and [`COMPATIBILITY.md`](../devices/contract/COMPATIBILITY.md) alongside it; [`devices/reachy-mini/`](../devices/reachy-mini/) is the worked example.
