...
| Agent-runtime health | `os/services/internal/openclaw/service_ws.go:43`, `internal/claudecode/client.go:57`, `internal/codex/client.go:60`, `internal/picoclaw/client.go:50`, `internal/hermes/health.go:126` | Every agent runtime sets `StateAgentDown` when its socket drops so the user sees the LED go red without having to check logs. |
