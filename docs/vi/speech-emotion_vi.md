...
VoiceService._stream_session(...) finally   ← cuối MỌI phiên mic
    ...
    │
    ├─ Phân loại wake word ở đầu `combined` → final_text nguyên văn + event_type
...
OpenClaw / sensing pipeline xử lý như sự kiện sensing khác (xem [sensing-behavior_vi.md](../../robots/lamp/docs/vi/sensing-behavior_vi.md)).
...
Chi tiết tuning / log: [sensing-tuning_vi.md](../../robots/lamp/docs/vi/sensing-tuning_vi.md).
