...
TWITCH_IRC_BIN="${ROOT_DIR}/integrations/chat-hooks/twitch-chat-hook/twitch-irc"
VERSION_FILE="${ROOT_DIR}/integrations/chat-hooks/twitch-chat-hook/${VERSION_FILE:-VERSION_TWITCH_IRC}"
