...
DIST_DIR="${ROOT_DIR}/services/web/dist"
ZIP_NAME="setup-web.zip"
ZIP_PATH="${ROOT_DIR}/${ZIP_NAME}"
VERSION_FILE="${ROOT_DIR}/services/VERSION_WEB"

# Bucket for web bundle

echo "========== npm install =========="
(cd "$ROOT_DIR/services/web" && npm install)
...
echo "========== npm run build =========="
(cd "$ROOT_DIR/services/web" && npm run build)
